...
- (void)markTilesForDates:(NSArray *)dates showMultipleMarkers:(BOOL)showMultipleMarkers { [gridView markTilesForDates:dates showMultipleMarkers:showMultipleMarkers]; }
